...
SLv = load("../Part_3/Pliki_mat_SL_zakl/SL_zakl.mat");
NPLv = load("NPL_zakl.mat");
...
xlabel("k")
ylabel("h_2")
legend("DMC","FDMC","SL","NPL",Location="west",Orientation="vertical")
...
stairs(1:kk,NPLv.F1in)
hold off
xlabel("k")
ylabel("F1in")
title("F1in")
legend("DMC","FDMC","SL","NPL",Location="south",Orientation="horizontal")
ylim([50, 90])
exportgraphics(f,'NPL_zakl_por.pdf')

else

%Plot wyjście
SLv = load("NPL_zakl.mat");
f = figure;
subplot(3,1,1)
hold on;
stairs(1:kk, SLv.h2)
...
ylabel("h_2")
legend("SL","y_z_a_d")
title("Regulaotr NPL, error = " + SLv.err_sum)
ylim([25, 50])
...
title("F1in")
ylim([50, 90])
exportgraphics(f,'NPL_zakl_zmiana_wart.pdf')
